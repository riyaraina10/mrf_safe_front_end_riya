                    ...
                    <div className="mt-6 flex text-xs gap-6 mb-4">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        Sprint Alpha sector 2
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="sprint_photo2_Alpha"
                                    name="sprint_photo2_Alpha"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="sprint_photo2_Alpha_datepicker"
                                    name="sprint_photo2_Alpha_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="sprint_photo2_Alpha_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        Sprint Alpha sector 3
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="sprint_photo3_Alpha"
                                    name="sprint_photo3_Alpha"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="sprint_photo3_Alpha_datepicker"
                                    name="sprint_photo3_Alpha_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="sprint_photo3_Alpha_img"
                                ></img>
                            </div>
                        </div>
                    </div>
