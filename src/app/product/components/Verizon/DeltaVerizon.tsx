                    ...
                    <div className="mt-6 flex text-xs gap-6 mb-4">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        verizon Delta sector 2
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="verizon_photo2_Delta"
                                    name="verizon_photo2_Delta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="verizon_photo2_Delta_datepicker"
                                    name="verizon_photo2_Delta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="verizon_photo2_Delta_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        verizon Delta sector 3
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="verizon_photo3_Delta"
                                    name="verizon_photo3_Delta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="verizon_photo3_Delta_datepicker"
                                    name="verizon_photo3_Delta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="verizon_photo3_Delta_img"
                                ></img>
                            </div>
                        </div>
                    </div>
