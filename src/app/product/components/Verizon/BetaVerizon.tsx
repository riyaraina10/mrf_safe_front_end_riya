                    ...
                    <div className="mt-6 flex text-xs gap-6 mb-4">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        verizon Beta sector 2
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="verizon_photo2_Beta"
                                    name="verizon_photo2_Beta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="verizon_photo2_Beta_datepicker"
                                    name="verizon_photo2_Beta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="verizon_photo2_Beta_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        verizon Beta sector 3
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="verizon_photo3_Beta"
                                    name="verizon_photo3_Beta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="verizon_photo3_Beta_datepicker"
                                    name="verizon_photo3_Beta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="verizon_photo3_Beta_img"
                                ></img>
                            </div>
                        </div>
                    </div>
