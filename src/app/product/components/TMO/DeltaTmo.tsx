    ...
    return (
        <>
            ...
            <div className="bg-white p-3 mb-4">
                <div>
                    <h4 className="text-center">T-Mobile Delta Sector</h4>
                </div>
                    ...
                    <div className="mt-6 flex text-xs gap-6 mb-4">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        T-Mobile Delta sector 2
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo2_Delta"
                                    name="tmobile_photo2_Delta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo2_Delta_datepicker"
                                    name="tmobile_photo2_Delta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="tmobile_photo2_Delta_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        T-Mobile Delta sector 3
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo3_Delta"
                                    name="tmobile_photo3_Delta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo3_Delta_datepicker"
                                    name="tmobile_photo3_Delta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="tmobile_photo3_Delta_img"
                                ></img>
                            </div>
                        </div>
                    </div>
