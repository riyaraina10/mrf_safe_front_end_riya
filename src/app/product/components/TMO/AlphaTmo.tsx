    ...
    return (
        <>
            <div className="bg-white p-3 mb-4">
                <div>
                    <h4 className="text-center">T-Mobile Alpha Sector</h4>
                </div>
                <form id="section_25" method="POST">
                    <div className="mt-6 flex text-xs gap-6 mb-4">
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        T-Mobile Alpha sector
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    ...
                                    id="photo_picker_75"
                                    name="photo_picker_75"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="photo_picker_75_datepicker"
                                    name="photo_picker_75_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="photo_picker_75_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <select
                                    ...
                                    id="tmobile_antenna_available"
                                    name="tmobile_antenna_available"
                                >
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        T-Mobile Alpha sector 2
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo2_Alpha"
                                    name="tmobile_photo2_Alpha"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo2_Alpha_datepicker"
                                    name="tmobile_photo2_Alpha_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="tmobile_photo2_Alpha_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <input
                                    ...
                                    name="tmobile_antenna_bottom_tip_height"
                                    id="tmobile_antenna_bottom_tip_height"
                                    value="1"
                                />
                            </div>
                            <div
                            ...
                            >
                                ...
                                <textarea
                                    ...
                                    name="tmobile_azimuth_comment"
                                    id="tmobile_azimuth_comment"
                                ></textarea>
                            </div>
                        </div>
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                <p>
                                    <strong className="text-xs">
                                        T-Mobile Alpha sector 3
                                    </strong>
                                </p>
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo3_Alpha"
                                    name="tmobile_photo3_Alpha"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="tmobile_photo3_Alpha_datepicker"
                                    name="tmobile_photo3_Alpha_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="tmobile_photo3__img"
                                ></img>
                            </div>
                        </div>
                    </div>
