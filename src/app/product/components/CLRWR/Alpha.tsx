    ...
    return (
        <>
            <div className="bg-white p-3 mb-4">
                <div>
                    <h4 className="text-center">CLRWR Alpha Sector</h4>
                </div>
                <form id="section_27" method="POST">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    id="photo_picker_87"
                                    name="photo_picker_87"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="photo_picker_87_datepicker"
                                    name="photo_picker_87_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="photo_picker_87_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <select
                                    ...
                                    name="clrwr_antenna_available"
                                    id="clrwr_antenna_available"
                                >
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="clwr_photo2_Alpha"
                                    name="clwr_photo2_Alpha"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="clwr_photo2_Alpha_datepicker"
                                    name="clwr_photo2_Alpha_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="clwr_photo2_Alpha_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <input
                                    ...
                                    name="clrwr_antenna_bottom_tip_height"
                                    id="clrwr_antenna_bottom_tip_height"
                                />
                            </div>
                            <div
                                className={
                            ...
                            >
                                ...
                                <textarea
                                    ...
                                    name="clrwr_azimuth_comment"
                                    id="clrwr_azimuth_comment"
                                ></textarea>
                            </div>
                        </div>
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="clwr_photo3_Alpha"
                                    name="clwr_photo3_Alpha"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="clwr_photo3_Alpha_datepicker"
                                    name="clwr_photo3_Alpha_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="clwr_photo3_Alpha_img"
                                ></img>
                            </div>
                        </div>
                    </div>
