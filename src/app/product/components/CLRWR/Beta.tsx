    ...
    return (
        <>
            <div className="bg-white p-3 mb-4">
                <div>
                    <h4 className="text-center">CLRWR Beta Sector</h4>
                </div>
                <form id="section_27_beta" method="POST">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    id="photo_picker_88"
                                    name="photo_picker_88"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="photo_picker_88_datepicker"
                                    name="photo_picker_88_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="photo_picker_88_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <select
                                    ...
                                    name="clrwr_antenna_available_beta"
                                    id="clrwr_antenna_available_beta"
                                >
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <select
                                    ...
                                    name="clrwr_azimuth_beta"
                                    id="clrwr_azimuth_beta"
                                    value={azimuth}
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="clwr_photo2_Beta"
                                    name="clwr_photo2_Beta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="clwr_photo2_Beta_datepicker"
                                    name="clwr_photo2_Beta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="clwr_photo2_Beta_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <input
                                    ...
                                    name="clrwr_antenna_bottom_tip_height_beta"
                                    id="clrwr_antenna_bottom_tip_height_beta"
                                />
                            </div>
                            <div
                                className={
                            ...
                            >
                                ...
                                <textarea
                                    ...
                                    name="clrwr_azimuth_comment_beta"
                                    id="clrwr_azimuth_comment_beta"
                                ></textarea>
                            </div>
                        </div>
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="clwr_photo3_Beta"
                                    name="clwr_photo3_Beta"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="clwr_photo3_Beta_datepicker"
                                    name="clwr_photo3_Beta_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="clwr_photo3_Beta_img"
                                ></img>
                            </div>
                        </div>
                    </div>
