    ...
    return (
        <>
            <div className="bg-white p-3 mb-4">
                <div>
                    <h4 className="text-center">CLRWR Gamma Sector</h4>
                </div>
                <form id="section_27_gamma" method="POST">
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    ...
                                    id="photo_picker_89"
                                    name="photo_picker_89"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="photo_picker_89_datepicker"
                                    name="photo_picker_89_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="photo_picker_89_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <select
                                    ...
                                    name="clrwr_antenna_available_gamma"
                                    id="clrwr_antenna_available_gamma"
                                >
                            ...
                            <div className="flex flex-col gap-1">
                                ...
                                <select
                                    ...
                                    name="clrwr_azimuth_gamma"
                                    id="clrwr_azimuth_gamma"
                                    value={azimuth}
                        ...
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="clwr_photo2_Gamma"
                                    name="clwr_photo2_Gamma"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="clwr_photo2_Gamma_datepicker"
                                    name="clwr_photo2_Gamma_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="clwr_photo2_Gamma_img"
                                ></img>
                            </div>
                            <div className="flex flex-col gap-1">
                                <p>
                                ...
                                <input
                                    ...
                                    name="clrwr_antenna_bottom_tip_height_gamma"
                                    id="clrwr_antenna_bottom_tip_height_gamma"
                                />
                            </div>
                            <div
                                className={
                            ...
                            >
                                ...
                                <textarea
                                    ...
                                    name="clrwr_azimuth_comment_gamma"
                                    id="clrwr_azimuth_comment_gamma"
                                ></textarea>
                            </div>
                        </div>
                        <div className="flex flex-col gap-3 flex-1">
                            <div className="flex flex-col gap-1">
                                ...
                                <input
                                    type="file"
                                    className="input input-bordered p-1 input-sm w-full text-xs rounded-none"
                                    id="clwr_photo3_Gamma"
                                    name="clwr_photo3_Gamma"
                                ></input>
                                <input
                                    type="datetime-local"
                                    className="input input-bordered input-sm w-full text-xs rounded-none"
                                    id="clwr_photo3_Gamma_datepicker"
                                    name="clwr_photo3_Gamma_timestamp"
                                ></input>
                                <img
                                    src="images/cat.jpg"
                                    id="clwr_photo3_Gamma_img"
                                ></img>
                            </div>
                        </div>
                    </div>
