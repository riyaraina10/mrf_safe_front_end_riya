                ...
                <div className="bg-white p-3 mb-4">
                    <div>
                        <h4 className="text-center">
                            ATT Epsilon Sectors Post Photos
                        </h4>
                    </div>
                    <div>
                            ...
                            <div>
                                <div className="border-neutral-400 border-2 text-center mt-4 ">
                                    <h4 className="text-sky-800 font-bold ">
                                        Installed Signage & Barrier - Epsilon
                                    </h4>
                                </div>
                                <div className="flex m-5 gap-6 flex-wrap">
                                    <div className="flex flex-col gap-2 w-96 text-xs relative ">
                                        ...
                                        <Select
                                            ...
                                            name="parameters_post_epsilon[]"
                                        />
                                    </div>
                                    {headings.map((e, i) => (
                                        <>
                                            <div id={`epsilon_post_${e.name}`}>
                                ...
                                <div className="flex m-5 gap-6 flex-wrap">
                                    <div className="flex flex-col gap-2 w-96 text-xs relative ">
                                        ...
                                        <Select
                                            ...
                                            name="parameters_remove_epsilon[]"
                                            id="parameters_remove_epsilon"
                                        />
                                    </div>
                                    {removeHeadings.map((e, i) => (
                                        <>
                                            <div
                                                id={`epsilon_remove_${e.name}`}
                                            >
                                                <div className="flex flex-col text-xs gap-2 flex-grow w-96">
                                                    <p>
                                                        <strong>
