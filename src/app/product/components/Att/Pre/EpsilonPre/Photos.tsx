            ...
            <div className="bg-white p-3 mb-4">
                <div>
                    <h4 className="text-center">
                        ATT Epsilon Sectors Pre Photos
                    </h4>
                </div>
                <div>
                        ...
                        <div>
                            <div className="mt-6 flex gap-8">
                                <div className="flex flex-col text-xs w-1/3 gap-1">
                                    <p>
                                        <strong>
                                            Pre - ATT Epsilon Sector Picture
                                            from front
                                        </strong>
                            ...
                            <div className="mt-6 flex gap-8">
                                ...
                                <div className="flex flex-col gap-1 w-1/3 text-xs">
                                    <p>
                                        <strong>
                                            Pre - ATT Epsilon Sector signage
                                            photo
                                        </strong>
                                        <span className="text-red-600">*</span>
                                    </p>
                        ...
                        <div>
                            <div className="border-neutral-400 border-2 text-center mt-4 ">
                                <h4 className="text-sky-800 font-bold ">
                                    AT&T Epsilon - Antenna Array Info
                                </h4>
                            </div>
                            ...
                            <div className="flex mt-2 gap-4">
                                <div className="flex flex-col gap-1 w-1/3">
                                    <p>
                                        <strong className="text-xs">
                                            Pre - ATT Epsilon Sector lowest
                                            antenna height verification picture
                                        </strong>
                                ...
                                <div className="flex flex-col gap-1 w-1/3">
                                    ...
                                    ></input>
                                    <p className=" text-red-500 text-xs font-bold">
                                        Pre - ATT Epsilon Sector Lowest Antenna
